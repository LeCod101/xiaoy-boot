package cn.xiaoy.module.erp.controller.admin.stock.vo.out;
...
import static cn.xiaoy.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "小Y")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "附件 URL", example = "https://www.xiaoy.cn/1.doc")
    private String fileUrl;

    @Schema(description = "创建人", example = "小Y")
    private String creator;
    @Schema(description = "创建人名称", example = "小Y")
