package cn.xiaoy.module.erp.controller.admin.purchase.vo.supplier;
...
public class ErpSupplierRespVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "小Y系统")
    @ExcelProperty("供应商名称")
    private String name;

    @Schema(description = "联系人", example = "小Y")
    @ExcelProperty("联系人")
