package cn.xiaoy.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.xiaoy.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
