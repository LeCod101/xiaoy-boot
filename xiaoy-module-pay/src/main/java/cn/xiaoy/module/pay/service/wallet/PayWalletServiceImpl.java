...
import cn.xiaoy.module.pay.controller.admin.wallet.vo.wallet.PayWalletPageReqVO;
...
import cn.xiaoy.module.pay.dal.mysql.wallet.PayWalletMapper;
import cn.xiaoy.module.pay.dal.redis.wallet.PayWalletLockRedisDAO;
...
import cn.xiaoy.module.pay.service.wallet.bo.WalletTransactionCreateReqBO;
...
import static cn.xiaoy.module.pay.enums.wallet.PayWalletBizTypeEnum.PAYMENT;
import static cn.xiaoy.module.pay.enums.wallet.PayWalletBizTypeEnum.PAYMENT_REFUND;
...
public class PayWalletServiceImpl implements PayWalletService {
    ...
    public PayWalletDO getOrCreateWallet(Long userId, Integer userType) {
        ...
        if (wallet == null) {
            // 使用双重检查锁，保证钱包创建并发问题
            // https://localhost/xiaoy/pulls/1475/files
    ...
    public PayWalletTransactionDO reduceWalletBalance(Long walletId, Long bizId,
        ...
        return lockRedisDAO.lock(walletId, UPDATE_TIMEOUT_MILLIS, () -> {
            ...
            // 3. 生成钱包流水
            // 情况一：充值退款：balance 在冻结时已扣，updateWhenRechargeRefund 只扣 freeze_price，所以 afterBalance 不变。https://docs.xiaoy.cn/OJk9m
