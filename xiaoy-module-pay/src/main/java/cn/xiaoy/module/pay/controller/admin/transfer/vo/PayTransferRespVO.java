package cn.xiaoy.module.pay.controller.admin.transfer.vo;
...
public class PayTransferRespVO {
    ...
    @ExcelProperty("应用名称")
    @Schema(description = "应用名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "小Y")
    ...
    @Schema(description = "异步通知商户地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn")
