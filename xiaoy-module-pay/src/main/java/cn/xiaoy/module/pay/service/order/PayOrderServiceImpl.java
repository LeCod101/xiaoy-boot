...
import cn.xiaoy.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
...
import cn.xiaoy.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://localhost/xiaoy/xiaoy-cloud/issues/I8SM9H 场景
