package cn.xiaoy.module.pay.service.wallet;
...
import cn.xiaoy.module.pay.controller.app.wallet.vo.recharge.AppPayWalletRechargeCreateReqVO;
import cn.xiaoy.module.pay.dal.dataobject.order.PayOrderDO;
import cn.xiaoy.module.pay.dal.dataobject.wallet.PayWalletDO;
import cn.xiaoy.module.pay.dal.dataobject.wallet.PayWalletRechargeDO;
import cn.xiaoy.module.pay.dal.dataobject.wallet.PayWalletRechargePackageDO;
import cn.xiaoy.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import cn.xiaoy.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
...
import static cn.xiaoy.framework.common.util.number.MoneyUtils.fenToYuanStr;
import static cn.xiaoy.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static cn.xiaoy.module.pay.enums.ErrorCodeConstants.*;
import static cn.xiaoy.module.pay.enums.MessageTemplateConstants.WXA_WALLET_RECHARGER_PAID;
import static cn.xiaoy.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @小Y：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
    ...
    public void updateWalletRechargerPaid(Long id, Long payOrderId) {
        ...
        // 4. 更新钱包余额
        // TODO @小Y：这样的话，未来提现会不会把充值的，也提现走哈。类似先充 100，送 110；然后提现 110；
        // TODO 需要钱包中加个可提现余额
