package cn.xiaoy.module.pay.framework.pay.core.client.impl.weixin;
...
import cn.xiaoy.framework.common.util.io.FileUtils;
...
import static cn.xiaoy.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static cn.xiaoy.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected void doInit(String tradeType) {
        ...
        if (Objects.equals(config.getApiVersion(), API_VERSION_V2)) {
            ...
            // 参考 https://gitee.com/xiaoycode/xiaoy-ui-admin-vue3/issues/ICUE53 和 https://docs.xiaoy.cn/ODR5V
            ...
            // 对应 https://docs.xiaoy.cn/5Q9lO 帖子
    ...
    protected PayOrderRespDTO doUnifiedOrder(PayOrderUnifiedReqDTO reqDTO) throws Exception {
        try {
            switch (config.getApiVersion()) {
                ...
                case API_VERSION_V3:
                    // TODO @小Y：【可能是 wxjava 的 bug】参考 https://github.com/binarywang/WxJava/issues/1557
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://localhost/xiaoy/xiaoy-cloud/issues/ICSFL6
