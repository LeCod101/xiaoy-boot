...
import static cn.xiaoy.module.pay.framework.pay.core.client.impl.weixin.AbstractWxPayClient.formatDateV3;
...
public class WxNativePayClientIntegrationTest {
    ...
    private WxPayConfig buildWxPayConfigV3() {
        ...
        config.setApiV3Key("YOUR_PAY_API_KEY");
//        config.setCertSerialNo(serialNo);
        config.setPrivateCertPath("/tmp/demo/Downloads/wx_pay/apiclient_cert.pem");
        config.setPrivateKeyPath("/tmp/demo/Downloads/wx_pay/apiclient_key.pem");
        return config;
    }
