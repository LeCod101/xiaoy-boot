...
import static cn.xiaoy.module.pay.framework.pay.core.client.impl.weixin.AbstractWxPayClient.formatDateV2;
...
//        config.setSignType(WxPayConstants.SignType.MD5);
        config.setKeyPath("/tmp/demo/Downloads/wx_pay/apiclient_cert.p12");
        return config;
    }
