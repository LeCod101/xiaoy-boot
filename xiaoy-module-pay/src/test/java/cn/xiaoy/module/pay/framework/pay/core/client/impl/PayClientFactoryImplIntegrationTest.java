package cn.xiaoy.module.pay.framework.pay.core.client.impl;
...
import cn.xiaoy.module.pay.framework.pay.core.client.impl.PayClientFactoryImpl;
import cn.xiaoy.module.pay.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import cn.xiaoy.module.pay.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import cn.xiaoy.module.pay.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import cn.xiaoy.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig;
import cn.xiaoy.module.pay.framework.pay.core.client.impl.weixin.WxPubPayClient;
...
public class PayClientFactoryImplIntegrationTest {
    ...
    public void testCreatePayClient_WX_PUB_V2() {
        ...
        config.setMchKey("YOUR_PAY_API_KEY");
        // 创建客户端
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_WX_PUB_V3() throws FileNotFoundException {
        ...
        config.setPrivateKeyContent(IoUtil.readUtf8(new FileInputStream("/tmp/demo/Downloads/wx_pay/apiclient_key.pem")));
//        config.setPrivateCertContent(IoUtil.readUtf8(new FileInputStream("/tmp/demo/Downloads/wx_pay/apiclient_cert.pem")));
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_ALIPAY_QR() {
        ...
        // 发起支付
        PayOrderUnifiedReqDTO reqDTO = buildPayOrderUnifiedReqDTO();
        reqDTO.setNotifyUrl("http://localhost/admin-api/pay/notify/callback/18"); // TODO @小Y: 这里改成你的 natapp 回调地址
