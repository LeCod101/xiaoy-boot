<template>
  <doc-alert title="审批通过、不通过、驳回" url="https://doc.xiaoy.cn/bpm/task-todo-done/" />
  <doc-alert title="审批加签、减签" url="https://doc.xiaoy.cn/bpm/sign/" />
  <doc-alert
    title="审批转办、委派、抄送"
    url="https://doc.xiaoy.cn/bpm/task-delegation-and-cc/"
  />
  <doc-alert title="审批加签、减签" url="https://doc.xiaoy.cn/bpm/sign/" />
