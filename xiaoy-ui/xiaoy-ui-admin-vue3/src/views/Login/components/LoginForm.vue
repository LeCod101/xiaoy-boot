  ...
  >
    <el-row class="mx-[-10px]">
      ...
      <el-col :span="24" class="px-10px">
        <el-form-item>
          <div class="w-full flex justify-between">
            <el-link href="https://doc.xiaoy.cn/" target="_blank">📚开发指南</el-link>
            <el-link href="https://doc.xiaoy.cn/video/" target="_blank">🔥视频教程</el-link>
            <el-link href="https://www.xiaoy.cn/Interview/good-collection/" target="_blank">
              ⚡面试手册
            </el-link>
            <el-link href="http://static.xiaoy.cn/mp/Aix9975.jpeg" target="_blank">
              🤝外包咨询
            </el-link>
          </div>
        </el-form-item>
