<template>
  <doc-alert title="代码生成（单表）" url="https://doc.xiaoy.cn/new-feature/" />
  <doc-alert title="代码生成（树表）" url="https://doc.xiaoy.cn/new-feature/tree/" />
  <doc-alert title="代码生成（主子表）" url="https://doc.xiaoy.cn/new-feature/master-sub/" />
  <doc-alert title="单元测试" url="https://doc.xiaoy.cn/unit-test/" />
