<template>
  <doc-alert title="定时任务" url="https://doc.xiaoy.cn/job/" />
  <doc-alert title="异步任务" url="https://doc.xiaoy.cn/async-task/" />
  <doc-alert title="消息队列" url="https://doc.xiaoy.cn/message-queue/" />
