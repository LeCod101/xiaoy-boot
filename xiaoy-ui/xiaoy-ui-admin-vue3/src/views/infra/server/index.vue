<template>
  <doc-alert title="服务监控" url="https://doc.xiaoy.cn/server-monitor/" />
...
onMounted(async () => {
  try {
    // 友情提示：如果访问出现 404 问题：
    // 1）boot 参考 https://doc.xiaoy.cn/server-monitor/ 解决；
    // 2）cloud 参考 https://cloud.xiaoy.cn/server-monitor/ 解决
