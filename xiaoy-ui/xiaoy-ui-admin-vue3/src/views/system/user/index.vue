<template>
  <doc-alert title="用户体系" url="https://doc.xiaoy.cn/user-center/" />
  <doc-alert title="三方登陆" url="https://doc.xiaoy.cn/social-user/" />
  <doc-alert title="Excel 导入导出" url="https://doc.xiaoy.cn/excel-import-and-export/" />
