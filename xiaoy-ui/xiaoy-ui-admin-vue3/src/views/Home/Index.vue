        ...
        <template #header>
          <div class="h-3 flex justify-between">
            ...
            <el-link
              type="primary"
              :underline="false"
              href="https://github.com/xiaoycode"
              target="_blank"
            >
              {{ t('action.more') }}
            </el-link>
  ...
  const data = [
    {
      ...
      message: 'github.com/xiaoy/xiaoy',
      personal: 'Spring Boot 单体架构',
      time: new Date('2025-01-02'),
      color: '#6DB33F'
    },
    {
      name: 'xiaoy-ui-admin-vue3',
      icon: 'ep:element-plus',
      message: 'github.com/xiaoycode/xiaoy-ui-admin-vue3',
      personal: 'Vue3 + element-plus 管理后台',
      time: new Date('2025-02-03'),
      color: '#409EFF'
    },
    {
      name: 'xiaoy-ui-mall-uniapp',
      icon: 'icon-park-outline:mall-bag',
      message: 'github.com/xiaoycode/xiaoy-ui-mall-uniapp',
    ...
    },
    {
      ...
      message: 'github.com/xiaoy/xiaoy-cloud',
      personal: 'Spring Cloud 微服务架构',
      time: new Date('2025-04-05'),
      color: '#1890ff'
    },
    {
      name: 'xiaoy-ui-admin-vben',
      icon: 'devicon:antdesign',
      message: 'github.com/xiaoycode/xiaoy-ui-admin-vben',
      personal: 'Vue3 + vben5(antd) 管理后台',
      time: new Date('2025-05-06'),
      color: '#e18525'
    },
    {
      name: 'xiaoy-ui-admin-uniapp',
      icon: 'ant-design:mobile',
      message: 'github.com/xiaoycode/xiaoy-ui-admin-uniapp',
