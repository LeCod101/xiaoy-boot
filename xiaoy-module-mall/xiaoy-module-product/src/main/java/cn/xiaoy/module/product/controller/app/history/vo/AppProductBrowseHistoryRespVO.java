package cn.xiaoy.module.product.controller.app.history.vo;
...
public class AppProductBrowseHistoryRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/pic.png")
