package cn.xiaoy.module.product.controller.app.spu.vo;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "小Y")
    private String name;
    ...
    public static class Sku {
        ...
        @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/xx.png")
        private String picUrl;
