package cn.xiaoy.module.product.service.history;
...
import cn.xiaoy.module.product.dal.mysql.history.ProductBrowseHistoryMapper;
...
public class ProductBrowseHistoryServiceImpl implements ProductBrowseHistoryService {
    ...
    public void createBrowseHistory(Long userId, Long spuId) {
        ...
        if (history != null) {
            ...
            // TODO @小Y：这里最好先查询一次数量。如果发现超过了，再删除；主要考虑，可能有部分不超过，提前就多了一次 sql 查询了
