package cn.xiaoy.module.product.controller.admin.spu.vo;

import cn.xiaoy.framework.excel.core.annotations.DictFormat;
import cn.xiaoy.framework.excel.core.convert.DictConvert;
import cn.xiaoy.framework.excel.core.convert.MoneyConvert;
import cn.xiaoy.module.product.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/xx.png")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.xiaoy.cn/xx.png, https://www.xiaoy.cn/xxx.png]")
