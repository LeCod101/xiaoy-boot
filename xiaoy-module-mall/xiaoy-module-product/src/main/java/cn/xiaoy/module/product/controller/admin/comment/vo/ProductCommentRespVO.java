package cn.xiaoy.module.product.controller.admin.comment.vo;
...
public class ProductCommentRespVO {
    ...
    @Schema(description = "评价人头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/xx.png")
    ...
    @Schema(description = "商品 SKU 图片地址", example = "https://www.xiaoy.cn/xiaoy.jpg")
    ...
    @Schema(description = "评论图片地址数组，以逗号分隔最多上传 9 张", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.xiaoy.cn/xx.png]")
