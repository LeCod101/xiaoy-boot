package cn.xiaoy.module.product.controller.app.comment.vo;

import cn.xiaoy.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductCommentRespVO {
    ...
    @Schema(description = "追评评价图片地址数组，以逗号分隔最多上传 9 张", example = "[https://www.xiaoy.cn/xx.png, https://www.xiaoy.cn/xxx.png]")
    ...
    @Schema(description = "评论图片地址数组，以逗号分隔最多上传 9 张", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "[https://www.xiaoy.cn/xx.png]")
