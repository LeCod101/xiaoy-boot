package cn.xiaoy.module.statistics.controller.admin.trade;
...
import cn.xiaoy.module.statistics.controller.admin.trade.vo.*;
import cn.xiaoy.module.statistics.convert.trade.TradeStatisticsConvert;
import cn.xiaoy.module.statistics.dal.dataobject.trade.TradeStatisticsDO;
import cn.xiaoy.module.statistics.service.trade.AfterSaleStatisticsService;
import cn.xiaoy.module.statistics.service.trade.BrokerageStatisticsService;
...
import cn.xiaoy.module.statistics.service.trade.bo.TradeSummaryRespBO;
...
public class TradeStatisticsController {
    ...
    public CommonResult<TradeOrderCountRespVO> getOrderCount() {
        ...
        // TODO @小Y：订单支付后，如果是门店自提的，需要 update 成 DELIVERED；；目前还没搞~~突然反应过来
