package cn.xiaoy.module.statistics.service.member;

import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.xiaoy.framework.common.enums.UserTypeEnum;
import cn.xiaoy.framework.ip.core.Area;
import cn.xiaoy.framework.ip.core.enums.AreaTypeEnum;
import cn.xiaoy.framework.ip.core.utils.AreaUtils;
import cn.xiaoy.module.statistics.controller.admin.common.vo.DataComparisonRespVO;
import cn.xiaoy.module.statistics.controller.admin.member.vo.*;
import cn.xiaoy.module.statistics.convert.member.MemberStatisticsConvert;
import cn.xiaoy.module.statistics.dal.mysql.member.MemberStatisticsMapper;
import cn.xiaoy.module.statistics.service.infra.ApiAccessLogStatisticsService;
import cn.xiaoy.module.statistics.service.member.bo.MemberAreaStatisticsRespBO;
import cn.xiaoy.module.statistics.service.pay.PayWalletStatisticsService;
import cn.xiaoy.module.statistics.service.pay.bo.RechargeSummaryRespBO;
import cn.xiaoy.module.statistics.service.trade.TradeOrderStatisticsService;
import cn.xiaoy.module.statistics.service.trade.TradeStatisticsService;
...
public class MemberStatisticsServiceImpl implements MemberStatisticsService {
    ...
    public MemberSummaryRespVO getMemberSummary() {
        ...
        // TODO @小Y：1）这里是实时统计，不好走走 TradeStatistics 表；2）因为这个放在商城下，所以只考虑订单数据，即按照 trade_order 的 pay_price 并且已支付来计算；
    ...
    public List<MemberAreaStatisticsRespVO> getMemberAreaStatisticsList() {
        // 统计用户
        // TODO @小Y：可能得把每个省的用户，都查询出来，然后去 order 那边 in；因为要按照这些人为基础来计算；；用户规模量大可能不太好，但是暂时就先这样搞吧 = =
