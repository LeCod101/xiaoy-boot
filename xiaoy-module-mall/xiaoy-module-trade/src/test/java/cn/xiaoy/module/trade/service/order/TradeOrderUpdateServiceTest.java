...
import cn.xiaoy.module.product.api.sku.ProductSkuApi;
import cn.xiaoy.module.product.api.spu.ProductSpuApi;
import cn.xiaoy.module.promotion.api.coupon.CouponApi;
import cn.xiaoy.module.system.api.notify.NotifyMessageSendApi;
import cn.xiaoy.module.trade.controller.admin.delivery.vo.express.DeliveryExpressCreateReqVO;
...
import cn.xiaoy.module.trade.enums.order.TradeOrderRefundStatusEnum;
import cn.xiaoy.module.trade.enums.order.TradeOrderStatusEnum;
import cn.xiaoy.module.trade.framework.order.config.TradeOrderConfig;
import cn.xiaoy.module.trade.framework.order.config.TradeOrderProperties;
import cn.xiaoy.module.trade.service.cart.CartServiceImpl;
import cn.xiaoy.module.trade.service.delivery.DeliveryExpressService;
import cn.xiaoy.module.trade.service.delivery.DeliveryExpressServiceImpl;
import cn.xiaoy.module.trade.service.message.TradeMessageServiceImpl;
import cn.xiaoy.module.trade.service.order.handler.TradeOrderHandler;
import cn.xiaoy.module.trade.service.price.TradePriceServiceImpl;
import cn.xiaoy.module.trade.service.price.calculator.TradePriceCalculator;
...
//        // mock 方法（用户收件地址的校验）
//        MemberAddressRespDTO addressRespDTO = new MemberAddressRespDTO().setId(10L).setUserId(userId).setName("小Y")
...
//        assertEquals(tradeOrderDO.getReceiverName(), "小Y");
