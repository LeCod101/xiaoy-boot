package cn.xiaoy.module.trade.controller.app.order.vo;
...
public class AppTradeOrderSettlementRespVO {
    ...
    public static class Item {
        ...
        @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/1.png")
