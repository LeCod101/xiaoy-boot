package cn.xiaoy.module.trade.convert.order;
...
import cn.xiaoy.framework.ip.core.utils.AreaUtils;
...
import cn.xiaoy.module.pay.enums.DictTypeConstants;
import cn.xiaoy.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.xiaoy.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.xiaoy.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.xiaoy.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.xiaoy.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.xiaoy.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.xiaoy.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.xiaoy.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.xiaoy.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.xiaoy.module.trade.controller.admin.order.vo.*;
import cn.xiaoy.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.xiaoy.module.trade.controller.app.order.vo.*;
import cn.xiaoy.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.xiaoy.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.xiaoy.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.xiaoy.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.xiaoy.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.xiaoy.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default PayOrderCreateReqDTO convert(TradeOrderDO order, List<TradeOrderItemDO> orderItems,
        ...
        createReqDTO.setBody(subject); // TODO 小Y：临时写死
        // 订单相关字段
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/xiaoycode/xiaoy-mall-uniapp/issues/ICY7SJ
