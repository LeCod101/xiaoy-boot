package cn.xiaoy.module.trade.controller.admin.brokerage;
...
import cn.xiaoy.module.trade.controller.admin.brokerage.vo.user.*;
...
import cn.xiaoy.module.trade.service.brokerage.BrokerageUserService;
import cn.xiaoy.module.trade.service.brokerage.BrokerageWithdrawService;
...
public class BrokerageUserController {
    ...
    public CommonResult<PageResult<BrokerageUserRespVO>> getBrokerageUserPage(@Valid BrokerageUserPageReqVO pageVO) {
        ...
        // 合计分佣的提现
        // TODO @小Y：如果未来支持了打款这个动作，可能 status 会不对；
