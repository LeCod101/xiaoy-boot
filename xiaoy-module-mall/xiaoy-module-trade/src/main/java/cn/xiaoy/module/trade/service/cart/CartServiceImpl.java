package cn.xiaoy.module.trade.service.cart;
...
import cn.xiaoy.module.trade.controller.app.cart.vo.*;
import cn.xiaoy.module.trade.convert.cart.TradeCartConvert;
import cn.xiaoy.module.trade.dal.dataobject.cart.CartDO;
import cn.xiaoy.module.trade.dal.mysql.cart.CartMapper;
...
import static cn.xiaoy.module.trade.enums.ErrorCodeConstants.CARD_ITEM_NOT_FOUND;
import static java.util.Collections.emptyList;

/**
 * 购物车 Service 实现类
 *
 * // TODO 小Y：未来优化：购物车的价格计算，支持营销信息；目前不支持的原因，前端界面需要前端 pr 支持下；例如说：会员价格；
 *
 * @author 小Y系统
 */
@Service
