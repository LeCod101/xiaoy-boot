...
import cn.xiaoy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import cn.xiaoy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import cn.xiaoy.module.trade.convert.brokerage.BrokerageRecordConvert;
...
import cn.xiaoy.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import cn.xiaoy.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static cn.xiaoy.framework.common.util.collection.CollectionUtils.getMaxValue;
import static cn.xiaoy.framework.common.util.collection.CollectionUtils.getMinValue;
import static cn.xiaoy.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
