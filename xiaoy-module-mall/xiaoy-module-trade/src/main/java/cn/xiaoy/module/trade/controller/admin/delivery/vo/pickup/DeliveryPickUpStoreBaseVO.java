package cn.xiaoy.module.trade.controller.admin.delivery.vo.pickup;
...
public class DeliveryPickUpStoreBaseVO {
    ...
    @Schema(description = "门店 logo", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/1.png")
