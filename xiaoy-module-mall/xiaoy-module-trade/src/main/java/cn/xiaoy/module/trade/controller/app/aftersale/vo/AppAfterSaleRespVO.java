package cn.xiaoy.module.trade.controller.app.aftersale.vo;
...
public class AppAfterSaleRespVO {
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/01.jpg")
