package cn.xiaoy.module.promotion.controller.admin.diy;

import cn.xiaoy.framework.common.pojo.CommonResult;
import cn.xiaoy.framework.common.pojo.PageResult;
import cn.xiaoy.module.promotion.controller.admin.diy.vo.template.*;
...
import cn.xiaoy.module.promotion.service.diy.DiyPageService;
import cn.xiaoy.module.promotion.service.diy.DiyTemplateService;
...
public class DiyTemplateController {
    ...
    // TODO @小Y：这个要不和 getDiyTemplate 合并，然后 DiyTemplateRespVO 里面直接把 DiyPagePropertyRespVO 也加上。减少 VO 好了，管理后台 get 多返回点数据，也问题不大的。目的，还是想尽可能降低大家的理解成本哈；
    ...
    // TODO @小Y：这个接口，要不和 useDiyTemplate 合并成一个，然后 VO 改成我们新的 VO 规范。不改的字段，就不传递。
