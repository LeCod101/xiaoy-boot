package cn.xiaoy.module.promotion.controller.app.diy;

import cn.xiaoy.framework.common.pojo.CommonResult;
import cn.xiaoy.module.promotion.controller.app.diy.vo.AppDiyTemplatePropertyRespVO;
...
import cn.xiaoy.module.promotion.enums.diy.DiyPageEnum;
...
public class AppDiyTemplateController {
    ...
    // TODO @小Y：要不要把 used 和 get 接口合并哈；不传递 id，直接拿默认；
    @GetMapping("/used")
