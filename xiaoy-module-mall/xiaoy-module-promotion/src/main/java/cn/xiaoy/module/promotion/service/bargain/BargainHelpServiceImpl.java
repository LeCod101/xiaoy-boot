...
import cn.xiaoy.module.promotion.controller.admin.bargain.vo.help.BargainHelpPageReqVO;
import cn.xiaoy.module.promotion.controller.app.bargain.vo.help.AppBargainHelpCreateReqVO;
import cn.xiaoy.module.promotion.dal.dataobject.bargain.BargainActivityDO;
import cn.xiaoy.module.promotion.dal.dataobject.bargain.BargainHelpDO;
import cn.xiaoy.module.promotion.dal.dataobject.bargain.BargainRecordDO;
import cn.xiaoy.module.promotion.dal.mysql.bargain.BargainHelpMapper;
...
public class BargainHelpServiceImpl implements BargainHelpService {
    ...
    // TODO 小Y：优化点：实现一个更随机的逻辑，可以按照你自己的业务；
