package cn.xiaoy.module.promotion.controller.app.article.vo.category;
...
public class AppArticleCategoryRespVO {
    ...
    @Schema(description = "分类图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/1.png")
