package cn.xiaoy.module.promotion.controller.admin.combination.vo.recrod;
...
public class CombinationRecordBaseVO {
    ...
    @Schema(description = "用户昵称", example = "小Y")
    private String nickname;

    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/xxx.jpg")
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/1.png")
