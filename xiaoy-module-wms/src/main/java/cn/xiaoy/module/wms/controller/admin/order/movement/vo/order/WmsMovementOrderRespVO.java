package cn.xiaoy.module.wms.controller.admin.order.movement.vo.order;
...
import cn.xiaoy.module.wms.enums.DictTypeConstants;
...
public class WmsMovementOrderRespVO {
    ...
    @Schema(description = "创建者名称", example = "小Y")
    ...
    @Schema(description = "更新者名称", example = "小Y")
