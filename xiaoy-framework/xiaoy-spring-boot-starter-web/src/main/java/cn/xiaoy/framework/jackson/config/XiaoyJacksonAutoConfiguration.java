package cn.xiaoy.framework.jackson.config;

import cn.xiaoy.framework.common.util.json.JsonUtils;
import cn.xiaoy.framework.common.util.json.databind.NumberSerializer;
import cn.xiaoy.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.xiaoy.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class XiaoyJacksonAutoConfiguration {
