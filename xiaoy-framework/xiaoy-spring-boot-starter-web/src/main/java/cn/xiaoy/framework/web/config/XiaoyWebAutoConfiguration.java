package cn.xiaoy.framework.web.config;
...
import cn.xiaoy.framework.web.core.filter.CacheRequestBodyFilter;
import cn.xiaoy.framework.web.core.filter.DemoFilter;
import cn.xiaoy.framework.web.core.handler.GlobalExceptionHandler;
import cn.xiaoy.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class XiaoyWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "xiaoy.demo", havingValue = "true")
