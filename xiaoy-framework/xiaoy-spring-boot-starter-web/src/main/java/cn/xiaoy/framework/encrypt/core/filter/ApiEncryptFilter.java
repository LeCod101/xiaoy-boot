package cn.xiaoy.framework.encrypt.core.filter;
...
import cn.xiaoy.framework.encrypt.config.ApiEncryptProperties;
import cn.xiaoy.framework.encrypt.core.annotation.ApiEncrypt;
...
public class ApiEncryptFilter extends ApiRequestFilter {
    ...
    private ApiEncrypt getApiEncrypt(HttpServletRequest request) {
        try {
            // 特殊：兼容 SpringBoot 2.X 版本会报错的问题 https://docs.xiaoy.cn/kqyiB
