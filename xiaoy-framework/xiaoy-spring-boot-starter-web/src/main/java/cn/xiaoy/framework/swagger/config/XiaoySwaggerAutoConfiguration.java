package cn.xiaoy.framework.swagger.config;
 ...
 * @author 小Y系统
 */
@AutoConfiguration(before = Knife4jAutoConfiguration.class) // before 原因，保证覆写的 Knife4jOpenApiCustomizer 先生效！相关 https://localhost/xiaoy/issues/954 讨论
@ConditionalOnClass({OpenAPI.class})
@EnableConfigurationProperties(SwaggerProperties.class)
@ConditionalOnProperty(prefix = "springdoc.api-docs", name = "enabled", havingValue = "true", matchIfMissing = true) // 设置为 false 时，禁用
@Import(Knife4jOpenApiCustomizer.class)
public class XiaoySwaggerAutoConfiguration {
     ...
     *
     * @see <a href="https://localhost/xiaoy/issues/957">app-api 前缀不生效，都是使用 admin-api</a>
     */
