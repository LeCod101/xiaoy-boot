package cn.xiaoy.framework.desensitize.core;

import cn.xiaoy.framework.common.util.json.JsonUtils;
import cn.xiaoy.framework.desensitize.core.annotation.Address;
import cn.xiaoy.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.xiaoy.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.xiaoy.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("小Y系统");
        ...
        desensitizeDemo.setRegex("你好，我是小Y系统");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("小Y系统");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("小***", d.getNickname());
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "小Y系统", replacer = "*")
