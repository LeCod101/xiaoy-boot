package cn.xiaoy.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${xiaoy.websocket.sender-rocketmq.topic}",
        consumerGroup = "${xiaoy.websocket.sender-rocketmq.consumer-group}",
