package cn.xiaoy.framework.quartz.core.scheduler;

import cn.xiaoy.framework.quartz.core.enums.JobDataKeyEnum;
import cn.xiaoy.framework.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw exception0(NOT_IMPLEMENTED.getCode(),
                    "[定时任务 - 已禁用][参考 https://doc.xiaoy.cn/job/ 开启]");
        }
    }
