...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.xiaoy";
    private static final String ARTIFACT_ID = "xiaoy";
    private static final String PACKAGE_NAME = "cn.xiaoy";
    private static final String TITLE = "小Y系统";
