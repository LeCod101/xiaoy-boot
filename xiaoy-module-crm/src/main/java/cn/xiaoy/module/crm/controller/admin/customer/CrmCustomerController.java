package cn.xiaoy.module.crm.controller.admin.customer;
...
import cn.xiaoy.module.crm.service.customer.CrmCustomerPoolConfigService;
...
public class CrmCustomerController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<CrmCustomerImportExcelVO> list = Arrays.asList(
                CrmCustomerImportExcelVO.builder().name("小Y").industryId(1).level(1).source(1)
                        .mobile("15601691300").telephone("").qq("").wechat("").email("admin@xiaoy.cn")
