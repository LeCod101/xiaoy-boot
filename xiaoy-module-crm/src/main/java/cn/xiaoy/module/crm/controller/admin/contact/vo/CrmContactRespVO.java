package cn.xiaoy.module.crm.controller.admin.contact.vo;
...
public class CrmContactRespVO {
    ...
    @Schema(description = "联系人姓名", example = "小Y")
    ...
    @DictFormat(cn.xiaoy.module.system.enums.DictTypeConstants.USER_SEX)
    private Integer sex;
    ...
    @Schema(description = "直属上级名", example = "小Y")
