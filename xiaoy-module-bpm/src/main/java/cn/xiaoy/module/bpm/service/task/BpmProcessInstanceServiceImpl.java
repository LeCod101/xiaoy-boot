...
import cn.xiaoy.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.xiaoy.module.bpm.controller.admin.task.vo.instance.*;
import cn.xiaoy.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.xiaoy.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.xiaoy.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.xiaoy.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.xiaoy.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.xiaoy.module.bpm.enums.ErrorCodeConstants;
import cn.xiaoy.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.xiaoy.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.xiaoy.module.bpm.enums.task.BpmAttachmentTypeEnum;
import cn.xiaoy.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.xiaoy.module.bpm.enums.task.BpmReasonEnum;
import cn.xiaoy.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.xiaoy.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.xiaoy.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.xiaoy.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.xiaoy.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.xiaoy.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
...
import cn.xiaoy.module.bpm.framework.flowable.core.util.SimpleModelUtils;
...
import static cn.xiaoy.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
...
import static cn.xiaoy.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    public BpmApprovalDetailRespVO getApprovalDetail(Long loginUserId, BpmApprovalDetailReqVO reqVO) {
        ...
        // 特殊：如果是未发起的场景，则设置发起用户，解决“发起流程”时，需要使用到该变量的问题。例如说：https://docs.xiaoy.cn/fMw5g
        if (historicProcessInstance == null) {
    ...
    public PageResult<HistoricProcessInstance> getProcessInstancePage(Long userId,
        ...
        if (CollUtil.isNotEmpty(formFieldsParams)) {
            formFieldsParams.forEach((key, value) -> {
                ...
                // TODO @小Y：应支持多种类型的查询方式，目前只有字符串全等
    ...
    private List<ActivityNode> getSimulateApproveNodeList(Long startUserId, BpmnModel bpmnModel,
        ...
        // TODO @小Y：【可优化】在驳回场景下，未来的预测准确性不高。原因是，驳回后，HistoricActivityInstance
    ...
    public void processProcessInstanceCompleted(ProcessInstance instance) {
        ...
        // 相关问题链接：https://docs.xiaoy.cn/kZhyb
    ...
    public void processProcessInstanceCreated(ProcessInstance instance) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            ...
            public void afterCommit() {
                ...
                // 相关问题链接：https://docs.xiaoy.cn/DF7Kq
