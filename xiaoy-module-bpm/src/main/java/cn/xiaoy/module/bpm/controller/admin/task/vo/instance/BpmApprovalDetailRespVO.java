package cn.xiaoy.module.bpm.controller.admin.task.vo.instance;
...
public class BpmApprovalDetailRespVO {
    ...
    public static class ActivityNodeTask {
        ...
        @Schema(description = "签名", example = "https://www.xiaoy.cn/sign.png")
        private String signPicUrl;

        @Schema(description = "附件", example = "[https://localhost/20260609/test.txt]")
