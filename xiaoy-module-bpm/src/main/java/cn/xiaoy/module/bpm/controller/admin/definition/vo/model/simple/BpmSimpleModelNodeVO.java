package cn.xiaoy.module.bpm.controller.admin.definition.vo.model.simple;
...
public class BpmSimpleModelNodeVO {
    ...
    @Schema(description = "节点展示内容", example = "指定成员: 小Y系统")
    ...
    public static class OperationButtonSetting {
        ...
        // TODO @小Y：是不是按钮的标识？id 会和数据库的 id 自增有点模糊，key 标识会更合理一点点哈。
