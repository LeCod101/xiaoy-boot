...
import cn.xiaoy.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
...
import cn.xiaoy.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static cn.xiaoy.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("小Y")));
       // 测试 status 不匹配
