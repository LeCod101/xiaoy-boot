package cn.xiaoy.module.im.controller.admin.group.vo.request;
...
public class ImGroupRequestRespVO {
    ...
    @Schema(description = "申请人 / 被邀请人昵称（实时聚合自 AdminUser）", example = "小Y")
    ...
    @Schema(description = "群名称（实时聚合自 ImGroup）", example = "小Y技术交流群")
