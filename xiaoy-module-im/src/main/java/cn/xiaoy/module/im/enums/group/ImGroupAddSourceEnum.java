package cn.xiaoy.module.im.enums.group;
...
public enum ImGroupAddSourceEnum implements ArrayValuable<Integer> {
    ...
    SEARCH(1, "搜索"), // TODO @小Y：SEARCH 暂未实现，原因 - 搜群入口尚未开发
    INVITE(2, "邀请"),
    QR_CODE(3, "扫码"), // TODO @小Y：QR_CODE 暂未实现，原因 - 群二维码扫码进群入口尚未开发
    SHARE_LINK(4, "分享链接"); // TODO @小Y：SHARE_LINK 暂未实现，原因 - 群分享链接进群入口尚未开发
