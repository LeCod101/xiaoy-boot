package cn.xiaoy.module.report.framework.jmreport.core.service;

import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import cn.xiaoy.framework.common.biz.system.oauth2.OAuth2TokenCommonApi;
import cn.xiaoy.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCheckRespDTO;
...
public class JmReportTokenServiceImpl implements JmReportTokenServiceI {
    ...
    public String[] getPermissions(String token) {
        ...
        // 如果不处理，会碰到 https://docs.xiaoy.cn/yzlkA 反馈的问题
        Long userId = SecurityFrameworkUtils.getLoginUserId();
