...
import static cn.xiaoy.module.system.enums.logger.LoginResultEnum.CAPTCHA_CODE_ERROR;
import static cn.xiaoy.module.system.enums.logger.LoginResultEnum.SUCCESS;
...
public class LoginLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetLoginLogPage() {
        ...
        // 测试 username 不匹配
        loginLogMapper.insert(cloneIgnoreId(loginLogDO, o -> o.setUsername("xiaoy")));
        // 测试 createTime 不匹配
