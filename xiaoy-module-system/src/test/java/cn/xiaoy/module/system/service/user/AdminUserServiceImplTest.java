package cn.xiaoy.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.xiaoy.framework.common.enums.CommonStatusEnum;
import cn.xiaoy.framework.common.exception.ServiceException;
import cn.xiaoy.framework.common.pojo.PageResult;
import cn.xiaoy.framework.common.util.collection.ArrayUtils;
import cn.xiaoy.framework.common.util.collection.CollectionUtils;
import cn.xiaoy.framework.test.core.ut.BaseDbUnitTest;
import cn.xiaoy.module.infra.api.config.ConfigApi;
import cn.xiaoy.module.infra.api.file.FileApi;
import cn.xiaoy.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.xiaoy.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.xiaoy.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.xiaoy.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.xiaoy.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.xiaoy.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.xiaoy.module.system.dal.dataobject.dept.DeptDO;
import cn.xiaoy.module.system.dal.dataobject.dept.PostDO;
import cn.xiaoy.module.system.dal.dataobject.dept.UserPostDO;
import cn.xiaoy.module.system.dal.dataobject.tenant.TenantDO;
import cn.xiaoy.module.system.dal.dataobject.user.AdminUserDO;
import cn.xiaoy.module.system.dal.mysql.dept.UserPostMapper;
import cn.xiaoy.module.system.dal.mysql.user.AdminUserMapper;
import cn.xiaoy.module.system.enums.common.SexEnum;
import cn.xiaoy.module.system.mq.producer.user.AdminUserProducer;
import cn.xiaoy.module.system.service.dept.DeptService;
import cn.xiaoy.module.system.service.dept.PostService;
import cn.xiaoy.module.system.service.oauth2.OAuth2TokenService;
import cn.xiaoy.module.system.service.permission.PermissionService;
import cn.xiaoy.module.system.service.tenant.TenantService;
...
import static cn.xiaoy.framework.common.util.collection.SetUtils.asSet;
import static cn.xiaoy.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.xiaoy.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.xiaoy.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.xiaoy.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.xiaoy.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.xiaoy.framework.test.core.util.RandomUtils.*;
import static cn.xiaoy.module.system.enums.ErrorCodeConstants.*;
import static cn.xiaoy.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("xiaoyyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("xiaoyyuanma");
        ...
        assertEquals("xiaoyyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("xiaoyyuanma"))).thenReturn("java");
    ...
    public void testGetUserListByNickname() {
        // mock 数据
        AdminUserDO user = randomAdminUserDO(o -> o.setNickname("小Y"));
        userMapper.insert(user);
        // 测试 nickname 不匹配
