package cn.xiaoy.module.system.service.dict;
...
import cn.xiaoy.module.system.controller.admin.dict.vo.data.DictDataPageReqVO;
import cn.xiaoy.module.system.controller.admin.dict.vo.data.DictDataSaveReqVO;
import cn.xiaoy.module.system.dal.dataobject.dict.DictDataDO;
import cn.xiaoy.module.system.dal.dataobject.dict.DictTypeDO;
import cn.xiaoy.module.system.dal.mysql.dict.DictDataMapper;
...
public class DictDataServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetDictDataList() {
        // mock 数据
        DictDataDO dictDataDO01 = randomDictDataDO().setDictType("xiaoy").setSort(2)
                .setStatus(CommonStatusEnum.ENABLE.getStatus());
        dictDataMapper.insert(dictDataDO01);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("xiaoy").setSort(1)
                .setStatus(CommonStatusEnum.ENABLE.getStatus());
        dictDataMapper.insert(dictDataDO02);
        DictDataDO dictDataDO03 = randomDictDataDO().setDictType("xiaoy").setSort(3)
                .setStatus(CommonStatusEnum.DISABLE.getStatus());
        dictDataMapper.insert(dictDataDO03);
        DictDataDO dictDataDO04 = randomDictDataDO().setDictType("xiaoy2").setSort(3)
                .setStatus(CommonStatusEnum.DISABLE.getStatus());
        dictDataMapper.insert(dictDataDO04);
        // 准备参数
        Integer status = CommonStatusEnum.ENABLE.getStatus();
        String dictType = "xiaoy";
    ...
    public void testGetDictDataPage() {
        ...
        // 测试 label 不匹配
        dictDataMapper.insert(cloneIgnoreId(dbDictData, o -> o.setLabel("其他")));
        // 测试 dictType 不匹配
    ...
    public void testGetDictDataCountByDictType() {
        // mock 数据
        dictDataMapper.insert(randomDictDataDO(o -> o.setDictType("xiaoy")));
    ...
    public void testGetDictData_dictType() {
        // mock 数据
        DictDataDO dictDataDO = randomDictDataDO().setDictType("xiaoy").setValue("1");
        dictDataMapper.insert(dictDataDO);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("xiaoy").setValue("2");
        dictDataMapper.insert(dictDataDO02);
        // 准备参数
        String dictType = "xiaoy";
        String value = "1";
    ...
    public void testParseDictData() {
        // mock 数据
        DictDataDO dictDataDO = randomDictDataDO().setDictType("xiaoy").setLabel("1");
        dictDataMapper.insert(dictDataDO);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("xiaoy").setLabel("2");
        dictDataMapper.insert(dictDataDO02);
        // 准备参数
        String dictType = "xiaoy";
        String label = "1";
