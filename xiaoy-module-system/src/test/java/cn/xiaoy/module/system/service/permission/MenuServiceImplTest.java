package cn.xiaoy.module.system.service.permission;

import cn.xiaoy.framework.common.enums.CommonStatusEnum;
import cn.xiaoy.framework.test.core.ut.BaseDbUnitTest;
import cn.xiaoy.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import cn.xiaoy.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import cn.xiaoy.module.system.dal.dataobject.permission.MenuDO;
import cn.xiaoy.module.system.dal.mysql.permission.MenuMapper;
import cn.xiaoy.module.system.enums.permission.MenuTypeEnum;
...
import static cn.xiaoy.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("小Y").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setStatus(CommonStatusEnum.DISABLE.getStatus())));
        // 测试 name 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setName("其他")));
        // 准备参数
        MenuListReqVO reqVO = new MenuListReqVO().setName("小").setStatus(CommonStatusEnum.ENABLE.getStatus());
