package cn.xiaoy.module.system.service.tenant;

import cn.xiaoy.framework.common.enums.CommonStatusEnum;
import cn.xiaoy.framework.common.pojo.PageResult;
import cn.xiaoy.framework.tenant.config.TenantProperties;
import cn.xiaoy.framework.tenant.core.context.TenantContextHolder;
import cn.xiaoy.framework.test.core.ut.BaseDbUnitTest;
import cn.xiaoy.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.xiaoy.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.xiaoy.module.system.dal.dataobject.permission.MenuDO;
...
import cn.xiaoy.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.xiaoy.module.system.dal.mysql.tenant.TenantMapper;
import cn.xiaoy.module.system.enums.permission.RoleCodeEnum;
import cn.xiaoy.module.system.enums.permission.RoleTypeEnum;
import cn.xiaoy.module.system.service.permission.MenuService;
import cn.xiaoy.module.system.service.permission.PermissionService;
import cn.xiaoy.module.system.service.permission.RoleService;
import cn.xiaoy.module.system.service.tenant.handler.TenantInfoHandler;
import cn.xiaoy.module.system.service.tenant.handler.TenantMenuHandler;
import cn.xiaoy.module.system.service.user.AdminUserService;
...
import static cn.xiaoy.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            assertEquals("xiaoy", user.getUsername());
            assertEquals("yuanma", user.getPassword());
            assertEquals("小Y", user.getNickname());
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            ...
            o.setWebsites(singletonList("https://www.xiaoy.cn"));
            o.setUsername("xiaoy");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("小Y"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("小Y");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsites(singletonList("https://www.xiaoy.cn")));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.xiaoy.cn");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
