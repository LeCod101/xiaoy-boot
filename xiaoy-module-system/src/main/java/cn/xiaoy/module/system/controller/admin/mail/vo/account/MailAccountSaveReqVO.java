package cn.xiaoy.module.system.controller.admin.mail.vo.account;
...
public class MailAccountSaveReqVO {
    ...
    @Schema(description = "邮箱", requiredMode = Schema.RequiredMode.REQUIRED, example = "xiaoyyuanma@123.com")
    @NotNull(message = "邮箱不能为空")
    @Email(message = "必须是 Email 格式")
    private String mail;

    @Schema(description = "用户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "xiaoy")
    ...
    @Schema(description = "SMTP 服务器域名", requiredMode = Schema.RequiredMode.REQUIRED, example = "www.xiaoy.cn")
