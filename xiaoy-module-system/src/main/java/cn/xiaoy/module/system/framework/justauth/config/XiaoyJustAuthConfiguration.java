package cn.xiaoy.module.system.framework.justauth.config;
...
/**
 * JustAuth 配置类 TODO 小Y：等 justauth 1.4.1 版本发布！！！
 *
 * @author 小Y系统
 */
@Configuration(proxyBeanMethods = false)
public class XiaoyJustAuthConfiguration {

    @Bean(name = "authRequestFactory2") // TODO @小Y：等 justauth1.4.1 发布，可以去掉
