...
import cn.xiaoy.framework.common.util.cache.CacheUtils;
import cn.xiaoy.framework.common.util.http.HttpUtils;
import cn.xiaoy.framework.common.util.object.BeanUtils;
import cn.xiaoy.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.xiaoy.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.xiaoy.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.xiaoy.module.system.dal.dataobject.social.SocialClientDO;
import cn.xiaoy.module.system.dal.mysql.social.SocialClientMapper;
import cn.xiaoy.module.system.dal.redis.RedisKeyConstants;
import cn.xiaoy.module.system.enums.social.SocialTypeEnum;
import cn.xiaoy.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.xiaoy.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.xiaoy.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${xiaoy.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${xiaoy.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://localhost/xiaoy/xiaoy-cloud/pulls/230
