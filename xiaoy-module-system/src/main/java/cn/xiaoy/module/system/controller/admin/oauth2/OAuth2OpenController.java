...
import cn.xiaoy.framework.common.util.http.HttpUtils;
...
import cn.xiaoy.module.system.convert.oauth2.OAuth2OpenConvert;
...
import cn.xiaoy.module.system.util.oauth2.OAuth2Utils;
...
import static cn.xiaoy.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
import static cn.xiaoy.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.xiaoy.cn"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.xiaoy.cn"),
