package cn.xiaoy.module.system.controller.admin.user;
...
import cn.xiaoy.module.system.controller.admin.user.vo.user.*;
import cn.xiaoy.module.system.convert.user.UserConvert;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("xiaoy").deptId(1L).email("admin@xiaoy.cn").mobile("15601691300")
                        .nickname("小Y").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("yuanma").deptId(2L).email("yuanma@xiaoy.cn").mobile("15601701300")
    ...
    @Parameter(name = "nickname", description = "昵称关键词", required = true, example = "小Y")
