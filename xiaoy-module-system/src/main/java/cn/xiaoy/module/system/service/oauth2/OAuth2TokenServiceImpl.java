...
import cn.xiaoy.framework.security.core.LoginUser;
...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    private OAuth2AccessTokenDO createOAuth2AccessToken(OAuth2RefreshTokenDO refreshTokenDO, OAuth2ClientDO clientDO) {
        ...
        // 可能关联的 issue：https://docs.xiaoy.cn/JIi5G
    ...
    /**
     * 加载用户信息，方便 {@link cn.xiaoy.framework.security.core.LoginUser} 获取到昵称、部门等信息
     *
     * @param userId 用户编号
     * @param userType 用户类型
     * @return 用户信息
