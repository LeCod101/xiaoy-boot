package cn.xiaoy.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientSaveReqVO {
    ...
    @Schema(description = "应用图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/xx.png")
    ...
    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn")
    ...
    @Schema(description = "附加信息", example = "{xiaoy: true}")
