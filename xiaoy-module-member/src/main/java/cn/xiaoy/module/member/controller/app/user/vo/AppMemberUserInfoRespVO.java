package cn.xiaoy.module.member.controller.app.user.vo;
...
public class AppMemberUserInfoRespVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/xxx.png")
    private String avatar;

    @Schema(description = "用户手机号", requiredMode = Schema.RequiredMode.REQUIRED, example = "15601691300")
    private String mobile;

    @Schema(description = "邮箱", example = "member@xiaoy.cn")
    ...
    public static class Level {
        ...
        @Schema(description = "等级名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "小Y")
        private String name;

        @Schema(description = "等级", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
        private Integer level;

        @Schema(description = "等级图标", example = "https://www.xiaoy.cn/xiaoy.jpg")
        private String icon;
