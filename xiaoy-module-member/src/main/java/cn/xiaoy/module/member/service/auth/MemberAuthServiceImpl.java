package cn.xiaoy.module.member.service.auth;

import cn.hutool.core.lang.Assert;
import cn.xiaoy.framework.common.enums.CommonStatusEnum;
import cn.xiaoy.framework.common.enums.TerminalEnum;
...
import cn.xiaoy.module.member.controller.app.auth.vo.*;
import cn.xiaoy.module.member.convert.auth.AuthConvert;
import cn.xiaoy.module.member.dal.dataobject.user.MemberUserDO;
import cn.xiaoy.module.member.service.user.MemberUserService;
import cn.xiaoy.module.system.api.logger.LoginLogApi;
import cn.xiaoy.module.system.api.logger.dto.LoginLogCreateReqDTO;
import cn.xiaoy.framework.common.biz.system.oauth2.OAuth2TokenCommonApi;
import cn.xiaoy.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import cn.xiaoy.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenRespDTO;
import cn.xiaoy.module.system.api.sms.SmsCodeApi;
import cn.xiaoy.module.system.api.social.SocialClientApi;
import cn.xiaoy.module.system.api.social.SocialUserApi;
import cn.xiaoy.module.system.api.social.dto.SocialUserBindReqDTO;
import cn.xiaoy.module.system.api.social.dto.SocialUserRespDTO;
import cn.xiaoy.module.system.api.social.dto.SocialWxPhoneNumberInfoRespDTO;
import cn.xiaoy.module.system.enums.logger.LoginLogTypeEnum;
import cn.xiaoy.module.system.enums.logger.LoginResultEnum;
import cn.xiaoy.module.system.enums.oauth2.OAuth2ClientConstants;
import cn.xiaoy.module.system.enums.sms.SmsSceneEnum;
import cn.xiaoy.module.system.enums.social.SocialTypeEnum;
...
import static cn.xiaoy.module.member.enums.ErrorCodeConstants.*;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO 小Y：后续 member user 手机非强绑定，这块需要做下调整；
