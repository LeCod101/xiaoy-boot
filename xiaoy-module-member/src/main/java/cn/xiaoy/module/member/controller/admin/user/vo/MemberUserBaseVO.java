package cn.xiaoy.module.member.controller.admin.user.vo;
...
public class MemberUserBaseVO {
    ...
    @Schema(description = "头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/x.png")
