...
public class MesProRouteProductDO extends BaseDO {
     ...
     * 产品物料编号
     *
     * 关联 {@link cn.xiaoy.module.mes.dal.dataobject.md.item.MesMdItemDO#getId()}
     */
    private Long itemId;
    /**
     * 生产数量
     ...
     * 时间单位
     *
     * 字典 {@link cn.xiaoy.module.mes.enums.DictTypeConstants#MES_TIME_UNIT_TYPE}
     * 枚举 {@link cn.xiaoy.module.mes.enums.pro.MesTimeUnitTypeEnum}
     */
