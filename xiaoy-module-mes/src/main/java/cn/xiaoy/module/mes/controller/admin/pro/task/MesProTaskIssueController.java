...
import cn.xiaoy.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import cn.xiaoy.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import cn.xiaoy.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import cn.xiaoy.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
import cn.xiaoy.module.mes.service.pro.task.MesProTaskIssueService;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return cn.xiaoy.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
