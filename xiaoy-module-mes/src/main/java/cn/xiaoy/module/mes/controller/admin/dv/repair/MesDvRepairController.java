package cn.xiaoy.module.mes.controller.admin.dv.repair;
...
import cn.xiaoy.module.mes.controller.admin.dv.repair.vo.MesDvRepairRespVO;
import cn.xiaoy.module.mes.controller.admin.dv.repair.vo.MesDvRepairSaveReqVO;
...
import cn.xiaoy.module.mes.service.dv.machinery.MesDvMachineryService;
...
public class MesDvRepairController {
    ...
    @PreAuthorize("@ss.hasPermission('mes:dv-repair:update')")
    public CommonResult<Boolean> confirmRepair(@Valid @RequestBody cn.xiaoy.module.mes.controller.admin.dv.repair.vo.MesDvRepairConfirmReqVO confirmReqVO) {
