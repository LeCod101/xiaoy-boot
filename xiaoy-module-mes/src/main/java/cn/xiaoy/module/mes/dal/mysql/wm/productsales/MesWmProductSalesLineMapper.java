package cn.xiaoy.module.mes.dal.mysql.wm.productsales;
...
public interface MesWmProductSalesLineMapper extends BaseMapperX<MesWmProductSalesLineDO> {
    ...
    default cn.xiaoy.framework.common.pojo.PageResult<MesWmProductSalesLineDO> selectPage(
            cn.xiaoy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO reqVO) {
        return selectPage(reqVO, new cn.xiaoy.framework.mybatis.core.query.LambdaQueryWrapperX<MesWmProductSalesLineDO>()
