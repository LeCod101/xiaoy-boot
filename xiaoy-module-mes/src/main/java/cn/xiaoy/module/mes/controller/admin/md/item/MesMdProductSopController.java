...
import cn.xiaoy.module.mes.controller.admin.md.item.vo.sop.MesMdProductSopPageReqVO;
import cn.xiaoy.module.mes.controller.admin.md.item.vo.sop.MesMdProductSopRespVO;
import cn.xiaoy.module.mes.controller.admin.md.item.vo.sop.MesMdProductSopSaveReqVO;
import cn.xiaoy.module.mes.dal.dataobject.md.item.MesMdProductSopDO;
import cn.xiaoy.module.mes.service.md.item.MesMdProductSopService;
...
public class MesMdProductSopController {
    ...
    public CommonResult<PageResult<MesMdProductSopRespVO>> getProductSopPage(@Valid MesMdProductSopPageReqVO pageReqVO) {
        ...
        // TODO @小Y：工序模块实现后，补充 processCode/processName 的 JOIN 逻辑
