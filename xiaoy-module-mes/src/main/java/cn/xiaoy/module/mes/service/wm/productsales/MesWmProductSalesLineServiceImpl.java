...
import cn.xiaoy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import cn.xiaoy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import cn.xiaoy.module.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import cn.xiaoy.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import cn.xiaoy.module.mes.enums.qc.MesQcCheckResultEnum;
...
import cn.xiaoy.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public cn.xiaoy.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return cn.xiaoy.framework.common.pojo.PageResult.empty();
            }
