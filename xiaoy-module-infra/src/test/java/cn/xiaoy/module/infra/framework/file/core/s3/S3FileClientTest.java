package cn.xiaoy.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testPresignGetUrl_publicAccess_encodeUrlPath() {
        ...
        config.setDomain("https://static.xiaoy.cn");
        ...
        // 断言
        assertEquals("https://static.xiaoy.cn/avatar/%E4%B8%AD%E6%96%87%20100%25+%E6%96%87%E4%BB%B6.jpg", result);
    }
    ...
    public void testPresignGetUrl_publicAccess_decodeDomainUrl() {
        ...
        // 调用
        String result = client.presignGetUrl("https://static.xiaoy.cn/avatar/%E4%B8%AD%E6%96%87%20100%25+%E6%96%87%E4%BB%B6.jpg?token=1", 300);
    ...
    public void testPresignGetUrl_privateAccess_rawPath() {
        ...
        config.setBucket("xiaoy");
        config.setDomain("http://127.0.0.1:9000/xiaoy");
        ...
        // 断言
        assertTrue(result.contains("/xiaoy/avatar/%E4%B8%AD%E6%96%87%20100%25"));
    ...
    public void testAliyun() throws Exception {
        ...
        config.setBucket("xiaoy-bucket");
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://ali-oss.xiaoy.cn
        // 默认北京的 endpoint
    ...
    public void testQCloud() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://tengxun-oss.xiaoy.cn
        // 默认上海的 endpoint
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("xiaoy");
        config.setDomain("http://localhost"); // 如果有自定义域名，则可以设置。http://static.xiaoy.cn
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        config.setAccessKey("b7yvuhBSAGjmtPhMFcn9iMOxUOY_I06cA_p0ZUx8");
        config.setAccessSecret("kXM1l5ia1RvSX3QaOEcwI3RLz3Y2rmNszWonKZtP");
        config.setBucket("xiaoy-private");
        config.setDomain("http://localhost"); // 如果有自定义域名，则可以设置。http://static.xiaoy.cn
        config.setEnablePathStyleAccess(false);
        // 默认上海的 endpoint
        config.setEndpoint("s3-cn-south-1.qiniucs.com");
