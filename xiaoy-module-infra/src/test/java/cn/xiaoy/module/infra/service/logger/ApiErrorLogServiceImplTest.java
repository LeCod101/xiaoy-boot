package cn.xiaoy.module.infra.service.logger;
...
import cn.xiaoy.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.xiaoy.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.xiaoy.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.xiaoy.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.xiaoy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.xiaoy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("xiaoy-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("xiaoy-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @小Y：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
