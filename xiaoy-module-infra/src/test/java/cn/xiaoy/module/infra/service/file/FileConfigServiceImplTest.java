package cn.xiaoy.module.infra.service.file;
...
import cn.xiaoy.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import cn.xiaoy.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import cn.xiaoy.module.infra.dal.dataobject.file.FileConfigDO;
import cn.xiaoy.module.infra.dal.mysql.file.FileConfigMapper;
import cn.xiaoy.module.infra.framework.file.core.client.FileClient;
import cn.xiaoy.module.infra.framework.file.core.client.FileClientConfig;
import cn.xiaoy.module.infra.framework.file.core.client.FileClientFactory;
import cn.xiaoy.module.infra.framework.file.core.client.local.LocalFileClient;
import cn.xiaoy.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import cn.xiaoy.module.infra.framework.file.core.enums.FileStorageEnum;
import lombok.Data;
...
import static cn.xiaoy.framework.test.core.util.RandomUtils.randomLongId;
import static cn.xiaoy.framework.test.core.util.RandomUtils.randomPojo;
import static cn.xiaoy.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static cn.xiaoy.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        // 准备参数
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/xiaoy")
                .put("domain", "https://www.xiaoy.cn").build();
        ...
        assertEquals("/xiaoy", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
        assertEquals("https://www.xiaoy.cn", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/xiaoy").setDomain("https://www.xiaoy.cn")));
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/xiaoy2")
                    .put("domain", "https://doc.xiaoy.cn").build();
            o.setConfig(config);
        });
        ...
        assertEquals("/xiaoy2", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
        assertEquals("https://doc.xiaoy.cn", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("小Y系统")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.xiaoy.cn");

        // 调用，并断言
        assertEquals("https://www.xiaoy.cn", fileConfigService.testFileConfig(id));
    }
