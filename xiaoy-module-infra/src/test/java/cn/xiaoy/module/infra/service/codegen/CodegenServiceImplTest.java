package cn.xiaoy.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import cn.xiaoy.framework.common.pojo.PageResult;
import cn.xiaoy.framework.test.core.ut.BaseDbUnitTest;
import cn.xiaoy.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import cn.xiaoy.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import cn.xiaoy.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import cn.xiaoy.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import cn.xiaoy.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.xiaoy.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import cn.xiaoy.module.infra.dal.dataobject.codegen.CodegenTableDO;
import cn.xiaoy.module.infra.dal.dataobject.db.DataSourceConfigDO;
import cn.xiaoy.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import cn.xiaoy.module.infra.dal.mysql.codegen.CodegenTableMapper;
import cn.xiaoy.module.infra.enums.codegen.CodegenFrontTypeEnum;
import cn.xiaoy.module.infra.enums.codegen.CodegenSceneEnum;
import cn.xiaoy.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import cn.xiaoy.module.infra.framework.codegen.config.CodegenProperties;
import cn.xiaoy.module.infra.service.codegen.inner.CodegenBuilder;
import cn.xiaoy.module.infra.service.codegen.inner.CodegenEngine;
import cn.xiaoy.module.infra.service.db.DataSourceConfigService;
import cn.xiaoy.module.infra.service.db.DatabaseTableService;
...
import static cn.xiaoy.module.infra.enums.ErrorCodeConstants.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        CodegenCreateListReqVO reqVO = randomPojo(CodegenCreateListReqVO.class,
                o -> o.setDataSourceConfigId(1L).setTableNames(Collections.singletonList("t_xiaoy")));
        // mock 方法（TableInfo）
        TableInfo tableInfo = mock(TableInfo.class);
        when(databaseTableService.getTable(eq(1L), eq("t_xiaoy")))
                .thenReturn(tableInfo);
        when(tableInfo.getComment()).thenReturn("小Y");
    ...
    public void testSyncCodegenFromDB() {
        ...
        CodegenTableDO table = randomPojo(CodegenTableDO.class, o -> o.setTableName("t_xiaoy")
    ...
    public void testGetCodegenTablePage() {
        ...
        CodegenTableDO tableDO = randomPojo(CodegenTableDO.class, o -> {
            o.setTableName("t_xiaoy");
            o.setTableComment("小Y");
            o.setClassName("SystemXiaoy");
        ...
        reqVO.setTableName("xiaoy");
        reqVO.setTableComment("小");
        reqVO.setClassName("Xiaoy");
    ...
    public void testGetDatabaseTableList() {
        ...
        when(tableInfo01.getName()).thenReturn("t_xiaoy");
        when(tableInfo01.getComment()).thenReturn("小Y");
        TableInfo tableInfo02 = mock(TableInfo.class);
        when(tableInfo02.getName()).thenReturn("t_xiaoy_02");
        when(tableInfo02.getComment()).thenReturn("小Y_02");
        ...
        // 断言
        assertEquals(1, result.size());
        assertEquals("t_xiaoy", result.get(0).getName());
        assertEquals("小Y", result.get(0).getComment());
    }
