package cn.xiaoy.module.infra.service.db;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.crypto.symmetric.AES;
import cn.xiaoy.framework.mybatis.core.type.EncryptTypeHandler;
import cn.xiaoy.framework.mybatis.core.util.JdbcUtils;
import cn.xiaoy.framework.test.core.ut.BaseDbUnitTest;
import cn.xiaoy.module.infra.controller.admin.db.vo.DataSourceConfigSaveReqVO;
import cn.xiaoy.module.infra.dal.dataobject.db.DataSourceConfigDO;
import cn.xiaoy.module.infra.dal.mysql.db.DataSourceConfigMapper;
...
import static cn.xiaoy.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
...
public class DataSourceConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUp() {
        ...
        dataSourceProperty.setUsername("xiaoy");
    ...
    public void testGetDataSourceConfig_master() {
        ...
        assertEquals("xiaoy", dataSourceConfig.getUsername());
    ...
    public void testGetDataSourceConfigList() {
        ...
        assertEquals("xiaoy", dataSourceConfigList.get(0).getUsername());
