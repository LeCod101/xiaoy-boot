...
import cn.xiaoy.framework.test.core.util.AssertUtils;
import cn.xiaoy.module.infra.controller.admin.file.vo.file.FileCreateReqVO;
import cn.xiaoy.module.infra.controller.admin.file.vo.file.FilePageReqVO;
import cn.xiaoy.module.infra.dal.dataobject.file.FileDO;
import cn.xiaoy.module.infra.dal.mysql.file.FileMapper;
...
import static cn.xiaoy.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
import static cn.xiaoy.module.infra.enums.ErrorCodeConstants.FILE_PATH_INVALID;
...
public class FileServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileByPresignedPath_success() {
        ...
        FileCreateReqVO reqVO = randomPojo(FileCreateReqVO.class, o -> {
            ...
            o.setName("test.jpg");
            o.setUrl("https://www.xiaoy.cn/test.jpg?token=123");
        });
        ...
        assertEquals("https://www.xiaoy.cn/test.jpg", file.getUrl());
    }
