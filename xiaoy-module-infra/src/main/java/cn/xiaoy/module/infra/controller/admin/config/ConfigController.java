package cn.xiaoy.module.infra.controller.admin.config;
...
import cn.xiaoy.module.infra.controller.admin.config.vo.ConfigRespVO;
import cn.xiaoy.module.infra.controller.admin.config.vo.ConfigSaveReqVO;
import cn.xiaoy.module.infra.convert.config.ConfigConvert;
import cn.xiaoy.module.infra.dal.dataobject.config.ConfigDO;
import cn.xiaoy.module.infra.enums.ErrorCodeConstants;
import cn.xiaoy.module.infra.service.config.ConfigService;
...
public class ConfigController {
    ...
    @Parameter(name = "key", description = "参数键", required = true, example = "xiaoy.biz.username")
