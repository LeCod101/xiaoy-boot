package cn.xiaoy.module.infra.controller.admin.codegen;
...
import cn.xiaoy.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.xiaoy.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.xiaoy.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.xiaoy.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.xiaoy.module.infra.convert.codegen.CodegenConvert;
...
import cn.xiaoy.module.infra.service.codegen.CodegenService;
...
import static cn.xiaoy.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.xiaoy.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "xiaoy"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "小Y")
    })
