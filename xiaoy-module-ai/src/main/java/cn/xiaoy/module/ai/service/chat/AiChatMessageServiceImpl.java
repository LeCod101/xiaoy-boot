package cn.xiaoy.module.ai.service.chat;
...
import cn.xiaoy.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.xiaoy.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.xiaoy.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.xiaoy.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.xiaoy.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.xiaoy.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.xiaoy.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.xiaoy.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.xiaoy.module.ai.dal.dataobject.model.AiModelDO;
import cn.xiaoy.module.ai.dal.dataobject.model.AiToolDO;
import cn.xiaoy.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.xiaoy.module.ai.enums.ErrorCodeConstants;
import cn.xiaoy.module.ai.enums.model.AiPlatformEnum;
...
import cn.xiaoy.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.xiaoy.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.xiaoy.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.xiaoy.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.xiaoy.module.ai.service.model.AiChatRoleService;
import cn.xiaoy.module.ai.service.model.AiModelService;
import cn.xiaoy.module.ai.service.model.AiToolService;
import cn.xiaoy.module.ai.util.AiUtils;
import cn.xiaoy.module.ai.util.FileTypeUtils;
...
import static cn.xiaoy.framework.common.pojo.CommonResult.error;
...
import static cn.xiaoy.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.xiaoy.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 xiaoy.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 xiaoy.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
