package cn.xiaoy.module.ai.framework.ai.core.model;
...
import cn.xiaoy.framework.common.util.spring.SpringUtils;
import cn.xiaoy.module.ai.enums.model.AiPlatformEnum;
import cn.xiaoy.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.xiaoy.module.ai.framework.ai.config.XiaoyAiProperties;
...
import cn.xiaoy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.xiaoy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            XiaoyAiProperties.Midjourney properties = SpringUtil.getBean(XiaoyAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(XiaoyAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        XiaoyAiProperties.DouBao properties = new XiaoyAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(XiaoyAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        XiaoyAiProperties.HunYuan properties = new XiaoyAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(XiaoyAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        XiaoyAiProperties.SiliconFlow properties = new XiaoyAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(XiaoyAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        XiaoyAiProperties.XingHuo properties = new XiaoyAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(XiaoyAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        XiaoyAiProperties.BaiChuan properties = new XiaoyAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(XiaoyAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        XiaoyAiProperties.Gemini properties = SpringUtil.getBean(XiaoyAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        XiaoyAiProperties.Grok properties = new XiaoyAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
