package cn.xiaoy.module.ai.controller.admin.knowledge.vo.knowledge;
...
public class AiKnowledgeSaveReqVO {
    ...
    @Schema(description = "知识库名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "xiaoy 用户指南")
    @NotBlank(message = "知识库名称不能为空")
    private String name;

    @Schema(description = "知识库描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "存储 xiaoy 操作文档")
