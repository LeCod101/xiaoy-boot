 ...
 *
 * TODO @小Y：注：spring-ai-alibaba-dashscope（1.1.2.2）的 {@code DashScopeImageApi#resolveImagePath} 未给 {@code wan2.7-image} 加路由分支，
...
public class TongYiImagesModelTest {
    ...
    private final DashScopeImageModel imageModel = DashScopeImageModel.builder()
            .dashScopeApi(DashScopeImageApi.builder()
                    .apiKey("sk-your-api-key") // https://bailian.console.aliyun.com/cn-beijing/?tab=model#/api-key 获取密钥
                    .build())
            .build();
