package cn.xiaoy.module.mp.controller.admin.menu.vo;
...
import static cn.xiaoy.module.mp.framework.mp.core.util.MpUtils.*;
...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "https://www.xiaoy.cn/")
