package cn.xiaoy.module.mp.service.account;
...
import cn.xiaoy.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.xiaoy.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.xiaoy.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.xiaoy.module.mp.convert.account.MpAccountConvert;
import cn.xiaoy.module.mp.dal.dataobject.account.MpAccountDO;
import cn.xiaoy.module.mp.dal.mysql.account.MpAccountMapper;
import cn.xiaoy.module.mp.enums.ErrorCodeConstants;
import cn.xiaoy.module.mp.framework.mp.core.MpServiceFactory;
...
import static cn.xiaoy.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 xiaoy-module-mp - 表结构未导入][参考 https://doc.xiaoy.cn/mp/build/ 开启]");
            }
