package cn.xiaoy.module.mp.controller.admin.user.vo;
...
public class MpUserRespVO  {
    ...
    @Schema(description = "昵称", example = "小Y")
    private String nickname;
    @Schema(description = "头像地址", example = "https://www.xiaoy.cn/1.png")
    ...
    private String city;
    @Schema(description = "备注", example = "你是一个小Y嘛")
