package cn.xiaoy.module.mp.controller.admin.material.vo;
...
public class MpMaterialRespVO {
    ...
    @Schema(description = "素材的 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/1.png")
    private String url;


    @Schema(description = "名字", example = "xiaoy.png")
    private String name;
