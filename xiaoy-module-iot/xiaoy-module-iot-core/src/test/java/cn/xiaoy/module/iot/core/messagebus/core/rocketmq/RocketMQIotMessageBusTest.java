package cn.xiaoy.module.iot.core.messagebus.core.rocketmq;

import cn.hutool.core.util.IdUtil;
import cn.xiaoy.module.iot.core.messagebus.config.IotMessageBusAutoConfiguration;
...
import cn.xiaoy.module.iot.core.messagebus.core.TestMessage;
...
@TestPropertySource(properties = {
        "xiaoy.iot.message-bus.type=rocketmq",
...
//                return "test-topic-consumer-01";
    ...
    public void testSendMessageWithTwoSubscribers() throws InterruptedException {
        ...
        String topic = "test-topic-" + IdUtil.simpleUUID();
//        String topic = "test-topic-pojo";
        TestMessage testMessage = new TestMessage().setNickname("xiaoy").setAge(18);
        // 用于等待消息处理完成
