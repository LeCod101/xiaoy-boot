package cn.xiaoy.module.iot.gateway.protocol.tcp;
...
import cn.xiaoy.module.iot.core.topic.topo.IotDeviceTopoGetReqDTO;
import cn.xiaoy.module.iot.core.util.IotDeviceAuthUtils;
import cn.xiaoy.module.iot.gateway.protocol.tcp.codec.IotTcpCodecTypeEnum;
import cn.xiaoy.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodec;
import cn.xiaoy.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodecFactory;
import cn.xiaoy.module.iot.gateway.serialize.IotMessageSerializer;
import cn.xiaoy.module.iot.gateway.serialize.json.IotJsonSerializer;
 ...
 * <p>使用步骤：
 * <ol>
 *     <li>启动 xiaoy-module-iot-gateway 服务（TCP 端口 8091）</li>
 *     <li>运行以下测试方法：
 *         <ul>
