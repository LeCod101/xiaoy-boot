package cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.xiaoy.framework.common.exception.enums.GlobalErrorCodeConstants;
import cn.xiaoy.framework.common.pojo.CommonResult;
import cn.xiaoy.framework.common.util.json.JsonUtils;
import cn.xiaoy.module.iot.core.biz.IotDeviceCommonApi;
import cn.xiaoy.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.xiaoy.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.xiaoy.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.xiaoy.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.xiaoy.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.xiaoy.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.xiaoy.module.iot.core.mq.message.IotDeviceMessage;
import cn.xiaoy.module.iot.core.topic.IotDeviceIdentity;
import cn.xiaoy.module.iot.core.util.IotDeviceAuthUtils;
import cn.xiaoy.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.xiaoy.module.iot.gateway.service.device.IotDeviceService;
import cn.xiaoy.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.xiaoy.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.xiaoy.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.xiaoy.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.xiaoy.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
