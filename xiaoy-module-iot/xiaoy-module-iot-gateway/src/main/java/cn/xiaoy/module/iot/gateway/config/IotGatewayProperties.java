...
import cn.xiaoy.module.iot.gateway.protocol.coap.IotCoapConfig;
import cn.xiaoy.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import cn.xiaoy.module.iot.gateway.protocol.http.IotHttpConfig;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import cn.xiaoy.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import cn.xiaoy.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import cn.xiaoy.module.iot.gateway.protocol.tcp.IotTcpConfig;
import cn.xiaoy.module.iot.gateway.protocol.udp.IotUdpConfig;
import cn.xiaoy.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
import lombok.Data;
...
@ConfigurationProperties(prefix = "xiaoy.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see cn.xiaoy.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see cn.xiaoy.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
