package cn.xiaoy.module.iot.service.device.message;
...
import cn.xiaoy.module.iot.controller.admin.device.vo.message.IotDeviceMessagePageReqVO;
import cn.xiaoy.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import cn.xiaoy.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
...
import cn.xiaoy.module.iot.core.mq.producer.IotDeviceMessageProducer;
import cn.xiaoy.module.iot.core.topic.IotDeviceIdentity;
import cn.xiaoy.module.iot.core.topic.event.IotDeviceEventPostReqDTO;
import cn.xiaoy.module.iot.core.topic.property.IotDevicePropertyPackPostReqDTO;
import cn.xiaoy.module.iot.core.topic.property.IotDevicePropertyPostReqDTO;
import cn.xiaoy.module.iot.core.util.IotDeviceMessageUtils;
import cn.xiaoy.module.iot.dal.dataobject.device.IotDeviceDO;
import cn.xiaoy.module.iot.dal.dataobject.device.IotDeviceMessageDO;
import cn.xiaoy.module.iot.dal.tdengine.IotDeviceMessageMapper;
import cn.xiaoy.module.iot.service.device.IotDeviceService;
import cn.xiaoy.module.iot.service.device.property.IotDevicePropertyService;
import cn.xiaoy.module.iot.service.ota.IotOtaTaskRecordService;
...
import static cn.xiaoy.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
...
public class IotDeviceMessageServiceImpl implements IotDeviceMessageService {
    ...
    private IotDeviceMessage sendDeviceMessage(IotDeviceMessage message, IotDeviceDO device, String serverId) {
        ...
        // TODO 小Y：【设计】下行消息需要区分 PUSH 和 PULL 模型
    ...
    // TODO @小Y：可优化：未来逻辑复杂后，可以独立拆除 Processor 处理器
