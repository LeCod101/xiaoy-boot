package cn.xiaoy.module.iot.service.device.property;
...
import cn.xiaoy.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import cn.xiaoy.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
import cn.xiaoy.module.iot.core.mq.message.IotDeviceMessage;
import cn.xiaoy.module.iot.dal.dataobject.device.IotDeviceDO;
import cn.xiaoy.module.iot.dal.dataobject.device.IotDevicePropertyDO;
...
import cn.xiaoy.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import cn.xiaoy.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import cn.xiaoy.module.iot.dal.tdengine.IotDevicePropertyMapper;
import cn.xiaoy.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import cn.xiaoy.module.iot.enums.thingmodel.IotThingModelTypeEnum;
...
import cn.xiaoy.module.iot.service.thingmodel.IotThingModelService;
...
import static cn.xiaoy.framework.common.util.collection.MapUtils.getBigDecimal;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void saveDeviceProperty(IotDeviceDO device, IotDeviceMessage message) {
        ...
        // 1. 根据物模型，拼接合法的属性
        // TODO @小Y：【待定 004】赋能后，属性到底以 thingModel 为准（ik），还是 db 的表结构为准（tl）？
