package cn.xiaoy.module.iot.controller.admin.ota.vo.firmware;
...
public class IotOtaFirmwareRespVO implements VO {
    ...
    @Schema(description = "固件文件 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.xiaoy.cn/firmware.bin")
