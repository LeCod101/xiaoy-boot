package cn.xiaoy.module.iot.controller.admin.product.vo.product;
...
import cn.xiaoy.module.iot.enums.product.IotNetTypeEnum;
...
public class IotProductSaveReqVO {
    ...
    @Schema(description = "产品图标", example = "https://xiaoy.cn/1.svg")
    private String icon;

    @Schema(description = "产品图片", example = "https://xiaoy.cn/1.png")
