package cn.xiaoy.module.iot.service.rule.action.databridge;
...
import cn.xiaoy.module.iot.dal.dataobject.rule.config.*;
import cn.xiaoy.module.iot.service.rule.data.action.*;
...
public class IotDataBridgeExecuteTest extends BaseMockitoUnitTest {
    ...
    public void testHttpDataBridge() throws Exception {
        ...
        IotDataSinkHttpConfig config = new IotDataSinkHttpConfig()
                .setUrl("https://doc.xiaoy.cn/").setMethod(HttpMethod.GET.name());
